    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h3 class="mb-6">Log In To Lyfex Admin Panel</h3>
                    <form class="bg-light rounded h-100 d-flex align-items-center p-5">
                        <div class="row g-3">
                            ...
                            <div>
                                <p class="mb-4">Don't have an account ?<a href="sign-up.php"> <span style="color:blue;">Sign Up Instead!</span></a></p>
                                <p class="mb-4">Forgot <a href="sign-up.php"> <span style="color:red;">Password</span></a> ? </p>
                            </div>
                        </div>
                    </form>
                </div>
