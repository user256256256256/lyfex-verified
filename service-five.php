...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header-service-five py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Tele Nutrition</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Services</li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Tele Nutrition</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <h4 class="mb-3">Virtual Consultations</h4>
                        <p class="mb-4">One-on-one nutrition counseling sessions conducted via video calls, phone calls, or online messaging. </p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <p class="mb-4">Tailored dietary recommendations and meal plans delivered digitally. </p>
                        <a class="btn" href="appointment.php"><i class="fa fa-plus text-primary me-3"></i>Book now</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <h4 class="mb-3">Follow-up and Support</h4>
                        <p class="mb-4">Regular virtual check-ins to monitor progress and adjust plans as needed. </p>
                        <a class="btn" href="appointment.php"><i class="fa fa-plus text-primary me-3"></i>Book now</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <p class="mb-4">Access to online materials, webinars, and interactive tools to support nutrition education. </p>
                        <a class="btn" href="appointment.php"><i class="fa fa-plus text-primary me-3"></i>Book now</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                            <i class="fa fa-calendar text-primary fs-4"></i>
                        </div>
                        <h4 class="mb-3">Flexible Scheduling</h4>
                        <p class="mb-4">Convenient appointment times to accommodate busy schedules and time zone differences. </p>
                        <a class="btn" href="appointment.php"><i class="fa fa-plus text-primary me-3"></i>Book now</a>
                    </div>
                </div>
            </div>
